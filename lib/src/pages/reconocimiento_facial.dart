import 'dart:convert';
import 'dart:io';
import 'package:notas/src/utils/detector_painters.dart';
import 'package:notas/src/utils/detector_utils.dart';
...
class ReconocimientoFacial extends StatefulWidget {
  @override
  _ReconocimientoFacialState createState() => _ReconocimientoFacialState();
}
...
class _ReconocimientoFacialState extends State<ReconocimientoFacial> {
  ...
  void _initializeCamera() async {
    ...
    print("Directorio:" + tempDir.path);
    jsonFile = new File(_embPath);
    print("Contenido: " + jsonFile.readAsStringSync());
